...
var navigationservice = angular.module('navigationservice', [])
  ...
  .factory('NavigationService', function ($http, TravelibroService) {
    ...
    var returnVal = {
      ...
      initializeOneSignal: function (callback) {
      ...
      requestForPushNotification: function () {
        if ($.jStorage.get("isLoggedIn") && $.jStorage.get('profile').alreadyLoggedIn) {
          console.log("Ensuring if Notification is enabled or not");
