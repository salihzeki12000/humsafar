  ...
  .controller('HomeCtrl', function ($scope, TemplateService, NavigationService, $timeout, $stateParams, cfpLoadingBar, $location, $state) {
    ...
    setTimeout(function(){
      ...
      // for mobile end
        ...
        // if($(document).scrollTop() >= ($('#discover').offset().top + $('#discover').height()/2 + 200)){
        //   console.log($(document).scrollTop(),'console value', $('#discover').offset().top,'offset discover', $('#discover').height()/2,'height discover');
        //   $('html, body').animate({scrollTop: $('.about-slider-holder').offset().top})
        //   console.log('huwa kya');
        // }
...
// city hotel filter end
  ...
  .controller('MylifeCtrl', function ($scope, $state, $stateParams, TemplateService, shareDataService, NavigationService, cfpLoadingBar, TravelibroService, $timeout, $uibModal, $location, $filter, MyLife, OnGoJourney, localLife, pastJourney, LikesAndComments, $anchorScroll, anchorSmoothScroll, $location) {
    ...
    $scope.addNewDraft = function (){
      $uibModal.open({
        animation: true,
        templateUrl: "views/modal/add-draft.html",
        scope: $scope,
        windowTopClass: "notify-popup"
      })
    };
  ...
  .controller('PastStoryCtrl', function ($scope, TemplateService, TravelibroService, shareDataService, NavigationService, pastJourney, $timeout, $stateParams, $state, LikesAndComments, $window, $http, $uibModal, $filter, $location) {
    //Used to name the .html file
